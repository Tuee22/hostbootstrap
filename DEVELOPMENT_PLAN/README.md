...
live-lane work there. The native Linux CPU/GPU lanes are also closed; Phase 18 remains Active for the
Apple Silicon lane and the blocked validated-service-selection repair. Other reopened phases own
implementation defects and cannot be closed by replaying those dated results.
