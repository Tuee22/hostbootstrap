...
Assistants should build an absolute path from the working directory the harness reports rather than
...
- Assistants must not intentionally change line endings.
