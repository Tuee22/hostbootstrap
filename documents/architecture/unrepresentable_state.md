...
| Authenticated recursive teardown entry (§ X/§ Y) — **implemented** | the exact child-entry wire consumed only with the implemented plan-bound `DescentWork` edge | `ForgeTeardownDescent.hs` |
