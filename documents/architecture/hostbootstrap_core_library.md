...
selects the effect without a caller flag. The shared recursive reverse command consumes that seam in Sprint
17.48.
...
paths or argument vectors. The protected store remains the Phase 16 clause holder; the removed Flock/Python
locking front end is not part of this backend.
