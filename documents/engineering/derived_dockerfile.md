...
image, builds and installs the project binary
(reusing the warm store), creates the in-container binary context, runs the code-check gate, then builds
the web bundle, with tini as PID 1. Its skeleton:
